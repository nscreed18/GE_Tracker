...
init()
#sub in item IDs from the runescape GE page where obj=**** is the item ID (end of URL)
...
for x in items:
    url = 'https://secure.runescape.com/m=itemdb_rs/api/catalogue/detail.json?item=' + x
